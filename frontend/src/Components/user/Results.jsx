        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="collapse bg-[#F9FAFC]">
            ...
            <div className="collapse-content bg-[#F9FAFC] text-sm font-bold flex flex-col gap-4">
              <p className="">
                الهيموغلوبين (Hemoglobin) هو بروتين موجود في خلايا الدم الحمراء،
                ويحتوي على ذرات الحديد، ويلعب دورًا حيويًا في نقل الأكسجين من
                الرئتين إلى أجزاء الجسم المختلفة.
              </p>
              ...
              <p className="pt-4">
                مستوى الهيموغلوبين لديك في النطاق الطبيعي, مما يشير الى عدم وجود
                مشاكل تتعلق بفقر الدم
              </p>
            </div>
          </div>
