...
function UserLogin() {
      ...
      return (
        ...
        <svg width="88" height="139" viewBox="0 0 88 139" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden md:block">
<path fill-rule="evenodd" clip-rule="evenodd" d="M0 45.8869C0 43.3498 2.05679 41.293 4.59397 41.293C7.13115 41.293 9.18794 43.3498 9.18794 45.8869V133.61C9.18794 136.147 7.13115 138.204 4.59397 138.204C2.05679 138.204 0 136.147 0 133.61L0 45.8869Z" fill="#C5D4E9" className="xs:hidden"/>
